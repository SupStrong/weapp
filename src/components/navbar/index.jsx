...
class NavBar extends Component {
  ...
  render() {
    ...
    if (title) {
      nav_bar__center = <text style={`color:${color};`}>{title}</text>;
    } else if (searchBar) {
      nav_bar__center = (
        <View
      ...
      >
        ...
        >
          <View className='lxy-nav-bar__left' style={navBarLeft}>
            ...
            {!back && home && (
              <View
                ...
                className={`lxy-nav-bar__button `}
              >
                <View className={`iconhuishouye iconfont ${iconTheme}`}> </View>
              </View>
            )}
            {back && home && (
              <View
              ...
              >
                ...
                <View
                  onClick={this.handleGoHomeClick.bind(this)}
                  className={`lxy-nav-bar__button iconhuishouye iconfont ${iconTheme}}`}
                />
              </View>
            )}
          ...
          <View
            ...
            style={`padding-left: ${rightDistance}px;color:${color}`}
          >
            {nav_bar__center}
          </View>
          <View
